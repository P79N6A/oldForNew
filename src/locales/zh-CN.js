...
export default {
  ...
  'menu.order': '终端',
  'menu.feedback': '数据',
  'menu.feedback.feedbackManage': '以旧换新数据',
  'menu.feedback.datainfo': '数据详情',
  'menu.order.orderManage': '销售终端管理',
  'menu.order.addterminal': '新增销售终端',
  'menu.order.orderExport': '订单导出',
  'menu.dashboard': '产品',
  'menu.dashboard.analysis': '产品型号管理',
  'menu.dashboard.addproduct': '新增产品',
  'menu.dashboard.monitor': '监控页',
  'menu.dashboard.workplace': '工作台',
  'menu.find': '发现',
  'menu.find.findSearch': '发现搜索',
  'menu.form': '表单页',
